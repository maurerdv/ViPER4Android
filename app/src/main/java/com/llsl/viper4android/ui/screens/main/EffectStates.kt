...
data class OutputState(
    ...
    fun forType(fxType: Int): OutputValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp
    ...
    fun updateType(
        ...
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
            copy(hp = hp.transform())
        }
}
...
data class AgcState(
    ...
    fun forType(fxType: Int): AgcValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: AgcValues.() -> AgcValues,
    ): AgcState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class LufsState(
    ...
    fun forType(fxType: Int): LufsValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: LufsValues.() -> LufsValues,
    ): LufsState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class FetState(
    ...
    fun forType(fxType: Int): FetValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: FetValues.() -> FetValues,
    ): FetState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class MbcState(
    ...
    fun forType(fxType: Int): MbcValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: MbcValues.() -> MbcValues,
    ): MbcState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class DdcState(
    ...
    fun forType(fxType: Int): DdcValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: DdcValues.() -> DdcValues,
    ): DdcState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class VseState(
    ...
    fun forType(fxType: Int): VseValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: VseValues.() -> VseValues,
    ): VseState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class EqState(
    ...
    fun forType(fxType: Int): EqValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: EqValues.() -> EqValues,
    ): EqState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class DynamicEqState(
    ...
    fun forType(fxType: Int): DynamicValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: DynamicValues.() -> DynamicValues,
    ): DynamicEqState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class ConvolverState(
    ...
    fun forType(fxType: Int): ConvolverValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: ConvolverValues.() -> ConvolverValues,
    ): ConvolverState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class FieldSurroundState(
    ...
    fun forType(fxType: Int): FieldSurroundValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp
...
data class DiffSurroundState(
    ...
    fun forType(fxType: Int): DiffSurroundValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp
...
data class StereoImagerState(
    ...
    fun forType(fxType: Int): StereoImagerValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp
...
data class VheState(
    ...
    fun forType(fxType: Int): VheValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: VheValues.() -> VheValues,
    ): VheState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class ReverbState(
    ...
    fun forType(fxType: Int): ReverbValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: ReverbValues.() -> ReverbValues,
    ): ReverbState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class DynamicSystemState(
    ...
    fun forType(fxType: Int): DynamicSystemValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp
...
data class PsychoBassState(
    ...
    fun forType(fxType: Int): PsychoBassValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp
...
data class BassState(
    ...
    fun forType(fxType: Int): BassValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: BassValues.() -> BassValues,
    ): BassState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class BassMonoState(
    ...
    fun forType(fxType: Int): BassMonoValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: BassMonoValues.() -> BassMonoValues,
    ): BassMonoState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class ClarityState(
    ...
    fun forType(fxType: Int): ClarityValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: ClarityValues.() -> ClarityValues,
    ): ClarityState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class CureState(
    ...
    fun forType(fxType: Int): CureValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: CureValues.() -> CureValues,
    ): CureState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class AnalogXState(
    ...
    fun forType(fxType: Int): AnalogXValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp

    fun updateType(
        fxType: Int,
        transform: AnalogXValues.() -> AnalogXValues,
    ): AnalogXState =
        if (fxType == ViperParams.FX_TYPE_SPEAKER) {
            copy(spk = spk.transform())
        } else {
...
data class TubeSimulatorState(
    ...
    fun forType(fxType: Int): TubeSimulatorValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp
...
data class SpeakerCorrectionState(
    ...
    fun forType(fxType: Int): SpeakerCorrectionValues = if (fxType == ViperParams.FX_TYPE_SPEAKER) spk else hp
